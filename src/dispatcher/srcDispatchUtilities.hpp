...
namespace srcDispatch {
    ...
    enum ParserState {decl, expr, parameter, declstmt, exprstmt, parameterlist, elseif, elsestmt, argumentlist, argumentlisttemplate, 
        ...
        trystmt, catchstmt, dostmt, incr, decr, control, ifgroup, range, returnstmt, foreachstmt, checkedstmt, uncheckedstmt,
        unsafestmt, fixedstmt, lockstmt, usingstmt, syncstmt,
