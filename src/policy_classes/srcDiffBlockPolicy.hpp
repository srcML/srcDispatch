...
#ifndef INCLUDED_SRCDIFF_BLOCK_POLICY_HPP
#define INCLUDED_SRCDIFF_BLOCK_POLICY_HPP
...
#include <srcDiffCasePolicy.hpp>
#include <srcDiffGotoPolicy.hpp>
#include <srcDiffLabelPolicy.hpp>
#include <srcDiffThrowPolicy.hpp>
