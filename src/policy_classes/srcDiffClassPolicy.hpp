...
#ifndef INCLUDED_SRCDIFF_CLASS_POLICY_HPP
#define INCLUDED_SRCDIFF_CLASS_POLICY_HPP
...
#include <srcDiffNamePolicy.hpp>
#include <srcDiffDeclStmtPolicy.hpp>
#include <srcDiffFunctionPolicy.hpp>
