...
#ifndef INCLUDED_SRCDIFF_CONTROL_POLICY_HPP
#define INCLUDED_SRCDIFF_CONTROL_POLICY_HPP
...
#include <srcDiffInitPolicy.hpp>
#include <srcDiffConditionPolicy.hpp>
#include <srcDiffIncrPolicy.hpp>
