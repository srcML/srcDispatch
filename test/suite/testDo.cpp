...
BOOST_AUTO_TEST_CASE(block_change_common_do) {
    ...
    BOOST_TEST(runner.GetFunctionInfo().at(0)->block->statements.at(0).ToString<std::shared_ptr<srcDiffDispatch::DoData>>() == "1");
...
BOOST_AUTO_TEST_CASE(block_insert_do) {
    ...
    const srcDiffDispatch::DoData& doData = *std::any_cast<std::shared_ptr<srcDiffDispatch::DoData>>(runner.GetFunctionInfo().at(0)->block->statements.at(0).GetElement());
    ...
    const srcDiffDispatch::ExpressionData& expr = *std::any_cast<std::shared_ptr<srcDiffDispatch::ExpressionData>>(doData.condition->conditions.at(0).GetElement());
    ...
    BOOST_TEST(doData.condition->conditions.at(0).ToString<std::shared_ptr<srcDiffDispatch::ExpressionData>>()                  == "|1");
...
BOOST_AUTO_TEST_CASE(block_replace_do) {
    ...
    const srcDiffDispatch::DoData& deletedData = *std::any_cast<std::shared_ptr<srcDiffDispatch::DoData>>(runner.GetFunctionInfo().at(0)->block->statements.at(0).GetElement());
    ...
    const srcDiffDispatch::DoData& insertedData = *std::any_cast<std::shared_ptr<srcDiffDispatch::DoData>>(runner.GetFunctionInfo().at(0)->block->statements.at(1).GetElement());
    ...
    BOOST_TEST(runner.GetFunctionInfo().at(0)->block->statements.at(1).ToString<std::shared_ptr<srcDiffDispatch::DoData>>() == "|2");
