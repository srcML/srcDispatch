...
BOOST_AUTO_TEST_CASE(block_change_common_switch) {
    ...
    BOOST_TEST(runner.GetFunctionInfo().at(0)->block->statements.at(0).ToString<std::shared_ptr<srcDiffDispatch::SwitchData>>() == "1");
...
BOOST_AUTO_TEST_CASE(block_insert_switch) {
    ...
    const srcDiffDispatch::ExpressionData& expr = *std::any_cast<std::shared_ptr<srcDiffDispatch::ExpressionData>>(switchData.condition->conditions.at(0).GetElement());
    ...
    BOOST_TEST(switchData.condition->conditions.at(0).ToString<std::shared_ptr<srcDiffDispatch::ExpressionData>>()              == "|1");
...
BOOST_AUTO_TEST_CASE(block_replace_switch) {
    ...
    const srcDiffDispatch::SwitchData& deletedData = *std::any_cast<std::shared_ptr<srcDiffDispatch::SwitchData>>(runner.GetFunctionInfo().at(0)->block->statements.at(0).GetElement());
    ...
    const srcDiffDispatch::SwitchData& insertedData = *std::any_cast<std::shared_ptr<srcDiffDispatch::SwitchData>>(runner.GetFunctionInfo().at(0)->block->statements.at(1).GetElement());
    ...
    BOOST_TEST(runner.GetFunctionInfo().at(0)->block->statements.at(1).ToString<std::shared_ptr<srcDiffDispatch::SwitchData>>() == "|2");
