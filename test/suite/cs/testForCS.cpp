...
#define BOOST_TEST_MODULE for_stmt_cs tests
...
// // for and control
BOOST_AUTO_TEST_CASE(block_common_for_cs) {
...
BOOST_AUTO_TEST_CASE(block_insert_for_cs) {
...
BOOST_AUTO_TEST_CASE(block_delete_for_cs) {
...
BOOST_AUTO_TEST_CASE(control_replace_for_cs) {
...
BOOST_AUTO_TEST_CASE(init_replace_for_cs) {
...
BOOST_AUTO_TEST_CASE(condition_replace_for_cs) {
...
BOOST_AUTO_TEST_CASE(incr_replace_for_cs) {
