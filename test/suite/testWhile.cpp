...
BOOST_AUTO_TEST_CASE(block_common_while) {
    ...
    const srcDiffDispatch::ExpressionData& expr = *std::any_cast<std::shared_ptr<srcDiffDispatch::ExpressionData>>(whileData.condition->conditions.at(0).GetElement());
    BOOST_TEST(expr.expr.size() == 1);
    BOOST_TEST(expr.expr.at(0).IsCommon());
    BOOST_TEST(std::any_cast<std::shared_ptr<srcDiffDispatch::LiteralData>>(expr.expr.at(0).GetElement())->literal.GetElement() == "1");
    BOOST_TEST(std::any_cast<std::shared_ptr<srcDiffDispatch::LiteralData>>(expr.expr.at(0).GetElement())->literal.ToString()   == "1");
    BOOST_TEST(expr.expr.at(0).ToString<std::shared_ptr<srcDiffDispatch::LiteralData>>()                                        == "1");
    BOOST_TEST(whileData.condition->conditions.at(0).ToString<std::shared_ptr<srcDiffDispatch::ExpressionData>>()               == "1");
...
BOOST_AUTO_TEST_CASE(block_insert_while) {
    ...
    BOOST_TEST(runner.GetFunctionInfo().at(0)->block->statements.at(0).ToString<std::shared_ptr<srcDiffDispatch::WhileData>>() == "|1");
...
BOOST_AUTO_TEST_CASE(block_change_condition_expr_while) {
    ...
    const srcDiffDispatch::ExpressionData& originalExpr = *std::any_cast<std::shared_ptr<srcDiffDispatch::ExpressionData>>(whileData.condition->conditions.at(0).GetOriginal());
    BOOST_TEST(originalExpr.expr.size() == 1);
    BOOST_TEST(originalExpr.expr.at(0).IsDelete());
    BOOST_TEST(originalExpr.expr.at(0).IsDelete());
    BOOST_TEST(originalExpr.expr.at(0).ToString<std::shared_ptr<srcDiffDispatch::LiteralData>>() == "1|");

    const srcDiffDispatch::ExpressionData& modifiedExpr = *std::any_cast<std::shared_ptr<srcDiffDispatch::ExpressionData>>(whileData.condition->conditions.at(0).GetModified());
    BOOST_TEST(modifiedExpr.expr.size() == 1);
    BOOST_TEST(modifiedExpr.expr.at(0).IsInsert());
    BOOST_TEST(modifiedExpr.expr.at(0).IsInsert());
    BOOST_TEST(modifiedExpr.expr.at(0).ToString<std::shared_ptr<srcDiffDispatch::LiteralData>>() == "|2");

    BOOST_TEST(whileData.condition->conditions.at(0).ToString<std::shared_ptr<srcDiffDispatch::ExpressionData>>()               == "1|2");
    BOOST_TEST(whileData.condition.ToString()                                                                                   == "1|2");

    BOOST_TEST(whileData.block.IsCommon());
    BOOST_TEST(whileData.block->statements.size()   == 0);

    BOOST_TEST(runner.GetFunctionInfo().at(0)->block->statements.at(0).ToString<std::shared_ptr<srcDiffDispatch::WhileData>>() == "1|2");
...
BOOST_AUTO_TEST_CASE(block_replace_while) {
    ...
    const srcDiffDispatch::WhileData& deletedData = *std::any_cast<std::shared_ptr<srcDiffDispatch::WhileData>>(runner.GetFunctionInfo().at(0)->block->statements.at(0).GetElement());
    ...
    const srcDiffDispatch::WhileData& insertedData = *std::any_cast<std::shared_ptr<srcDiffDispatch::WhileData>>(runner.GetFunctionInfo().at(0)->block->statements.at(1).GetElement());
    ...
    BOOST_TEST(runner.GetFunctionInfo().at(0)->block->statements.at(1).ToString<std::shared_ptr<srcDiffDispatch::WhileData>>() == "|2");
